...
# set opt(alt)		780; # Polar satellite altitude (Iridium) 780
# set opt(inc)		90; # Orbit inclination w.r.t. equator 90
set opt(alt) 	[lindex $argv 0];
set opt(inc)	[lindex $argv 1];
